/* 
 * Maybe is interesting to implement webfinger protocol for the users & calendars
 * I take this example code from connect-lrdd,
 * I only found one rel for vcal: http://json-schema.org/calendar
